...
if __name__ == "__main__":
    ...
    print(
        f"Temps moyen de cryptage SDES: {encryption_time_sdes / len(plain_messages_sdes):.8f} seconds"
    )
    print(
        f"Temps moyen de décryptage SDES: {decryption_time_sdes / len(plain_messages_sdes):.8f} seconds"
    )

    print(
        f"Durée moyenne du chiffrement AES: {encryption_time_aes / len(plain_messages_aes):.8f} seconds"
    )
    print(
        f"Temps moyen de décryptage AES: {decryption_time_aes / len(plain_messages_aes):.8f} seconds"
    )
